...
FLIGHT_PRICE_ENDPOINT = "https://test.api.amadeus.com/v2/shopping/flight-offers"
...
class FlightSearch:
    ...
    def get_flight_price(self, origin_city_code, destination_city_code, from_time, to_time, is_direct=True):
        ...
        response = requests.get(url=FLIGHT_PRICE_ENDPOINT, headers=headers, params=query)
